...
function ViewOverall()
	...
	local szText1;
	szText1 = Locale.Lookup("LOC_WOTFK_SCENARIO_WORLD_RANKING_1"); 
	Controls.WotFK1:SetText(szText1); 
	
	local szText2;
	szText2 = Locale.Lookup("LOC_WOTFK_SCENARIO_WORLD_RANKING_2"); 
	Controls.WotFK2:SetText(szText2); 
